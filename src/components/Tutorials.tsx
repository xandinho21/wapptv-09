      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <CarouselPrevious className="text-white border-gray-600 bg-gray-800/50 hover:bg-gray-700" />
            <CarouselNext className="text-white border-gray-600 bg-gray-800/50 hover:bg-gray-700" />
          </Carousel>
        </div>
      </div>
    </section>
