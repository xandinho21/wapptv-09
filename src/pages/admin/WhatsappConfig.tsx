...
import { Phone, Users, Plus, Trash2 } from 'lucide-react';

const WhatsappConfig = () => {
  const { adminData, updateContacts, updateResellerContacts } = useAdmin();
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-white mb-2">Configurar WhatsApp</h1>
        <p className="text-gray-400">Gerencie os números de WhatsApp e revendedores</p>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex gap-2 mt-2">
                ...
                />
                <Button onClick={addContact} size="sm" className="bg-green-500 hover:bg-green-600">
                  <Plus size={16} />
                </Button>
              </div>
            </div>
            ...
            <Button onClick={handleSaveContacts} className="w-full bg-green-500 hover:bg-green-600">
              Salvar Contatos
            </Button>
          </div>
        </div>
