          ...
          <CardHeader>
            <div className="flex justify-between items-center">
              ...
              <Button
                variant="destructive"
                size="sm"
                onClick={() => removeTutorial(type, index)}
              >
                <Trash2 size={16} />
              </Button>
            </div>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateTutorialField(type, index, 'title', e.target.value)}
            ...
            <div>
              ...
              <Input
                value={tutorial.link}
                onChange={(e) => updateTutorialField(type, index, 'link', e.target.value)}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => document.getElementById(`file-${type}-${index}`)?.click()}
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="wapp" className="w-full">
        <TabsList className="grid w-full grid-cols-2 bg-gray-800">
          ...
          <TabsTrigger value="krator" className="data-[state=active]:bg-purple-600">
            Tutoriais Krator
          </TabsTrigger>
        </TabsList>
