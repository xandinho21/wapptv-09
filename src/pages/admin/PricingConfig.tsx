...
const PricingConfig = () => {
  const { adminData, updateResellerSettings } = useAdmin();
  ...
  const [kratorPrice, setKratorPrice] = useState('R$ 35,00');
  ...
  const handleSaveKratorPrice = () => {
    // Aqui você salvaria o preço do Krator
    toast({
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <div className="space-y-4">
            {wappPrices.map((price, index) => (
              <div key={index} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-gray-700 rounded">
                <div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <div className="space-y-4">
            {resellerPrices.map((price, index) => (
              <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-700 rounded">
                <div>
            ...
            <div className="flex gap-2">
              <Button onClick={addResellerPrice} variant="outline" className="border-gray-600 text-gray-300">
                <Plus size={16} className="mr-2" />
                Adicionar Preço
              </Button>
